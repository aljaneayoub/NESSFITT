...
<section class="zone">
        <div class="text-zone">
        <b class="text">The more difficult the victory,<br>the greater the happiness in winning.<br><b>Our football area.</b></b>
        </div>
    ...
    <section class="product">
        ...
        $query = "SELECT * FROM produit WHERE categorie='football' ORDER BY RAND () LIMIT 3";
