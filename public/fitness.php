...
<section class="zone">
        <div class="text-zone">
        <b class="text">Strength does not come from physical capacity.<br>It comes from an indomitable will.<br><b>Our fitness area.</b></b>
        </div>
    ...
    <section class="product">
        ...
        $query = "SELECT * FROM produit WHERE categorie='fitness' ORDER BY RAND () LIMIT 3";
